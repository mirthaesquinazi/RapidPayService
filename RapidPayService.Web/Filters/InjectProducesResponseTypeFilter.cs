...
namespace RapidPayService.Web.Filters
{
    public class InjectProducesResponseTypeFilter : IOperationFilter
    {
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            Add_404NotFound(ref operation, ref context);
        ...
        private static void Add_404NotFound(ref OpenApiOperation operation, ref OperationFilterContext context)
        {
            AddResponse(ref operation, ref context, StatusCodes.Status404NotFound, null);
        }
